...
class SubmittedNotification extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'title'      => sprintf('Assessment submitted %s.', $this->request->auth_number),
            'message'    => sprintf('Request %s has been submitted for review.', $this->request->auth_number),
            'priority'   => 3, // warning
