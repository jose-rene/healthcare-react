...
class MemberRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'language_other'     => ['bail', 'required_without:language_id', 'min:1'],
            'language_id'        => ['bail', 'required_without:language_other', 'exists:languages,id'],
        ...
        // @note $this->route will be null if this is not pulled from service container, ie called directly from another context
