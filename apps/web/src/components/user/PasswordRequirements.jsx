...
const PasswordRequirements = ({
    ...
    const primaryRuleSet = [
        ...
        },
        {
            ...
            check: (_password, password_confirmation) => _password.length > 1 && password === password_confirmation,
        },
    ];
        ...
        (async () => {
            ...
            if (primaryDone && secondaryRules) {
                try {
                    ...
                    const passwordValidation = get(e, 'response.data.errors.password', false);
                    ...
                    switch (status) {
                        case 422:
                            ...
                            secondaryRuleSet.forEach(({ label }) => {
                                const foundRule = passwordValidation.findIndex(p => p == label);
                                if (foundRule >= 0) {
    ...
    return (
        <>
            ...
            <ul className="password-requirements list-unstyled">
                ...
                {secondaryRules && secondaryRuleSet.map((rule, i) => (
                    <li key={`password-requirement-${i}`}>
                        <div className="row">
                            <div className="col-1 pr-3">
