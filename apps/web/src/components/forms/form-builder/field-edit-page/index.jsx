...
export default class FormElementsEdit extends React.Component {
    ...
    editElementProp (elementName, propName, e) {
        ...
        this.setState({
            ...
            if (propName === 'checked') { this.updateElement(); }
        });
    }
    ...
    onEditorStateChange (index, property, editorContent) {
        ...
        const html = draftToHtml(convertToRaw(editorContent.getCurrentContent()))
            ...
            .replace(/\r\n|\r|\n/g, ' ');
        const this_element = this.state.element;
        set(this_element, property, html);
        ...
        return (
            <div>
                ...
                <div className="form-group">
                    <label className="control-label" htmlFor="custom_name">Name:</label>
                    <input id="custom_name" type="text" className="form-control"
                           defaultValue={this.props.element?.custom_name || this.props.element.props?.custom_name}
                ...
                <div>
                    ...
                    <div className="form-group">
                        <div className="custom-control custom-checkbox">
                            <input id="do-center" className="custom-control-input" type="checkbox"
                                   checked={this_checked_center} value={true}
                    ...
                    <div className="row">
                        <div className="col-sm-3">
                            ...
                            <input id="elementWidth" type="text" className="form-control"
                                   defaultValue={this.props.element.width} onBlur={this.updateElement.bind(this)}
                        ...
                        <div className="col-sm-3">
                            ...
                            <input id="elementHeight" type="text" className="form-control"
                                   defaultValue={this.props.element.height} onBlur={this.updateElement.bind(this)}
                ...
                <div className="form-group">
                    ...
                    <br />
                    <div className="custom-control custom-checkbox">
                        <input id="is-required" className="custom-control-input" type="checkbox" checked={this_checked}
                    ...
                    <div className="custom-control custom-checkbox">
                        <input id="is-read-only" className="custom-control-input" type="checkbox"
                               checked={this_read_only} value={true}
                    ...
                    <div className="custom-control custom-checkbox">
                        <input id="is-default-to-today" className="custom-control-input" type="checkbox"
                               checked={this_default_today} value={true}
                    ...
                    <div className="custom-control custom-checkbox">
                        <input id="show-time-select" className="custom-control-input" type="checkbox"
                               checked={this_show_time_select} value={true}
                    ...
                    <div className="custom-control custom-checkbox">
                        <input id="show-time-select-only" className="custom-control-input" type="checkbox"
                               checked={this_show_time_select_only} value={true}
                    ...
                    canHaveDisplayHorizontal &&
                    <div className="custom-control custom-checkbox">
                        <input id="display-horizontal" className="custom-control-input" type="checkbox"
                               checked={this_checked_inline} value={true}
                    ...
                    ? (
                        <div className="form-group">
                            ...
                            <input id="variableKey" type="text" className="form-control"
                                   defaultValue={this.props.element.variableKey} onBlur={this.updateElement.bind(this)}
                            ...
                            <p className="help-block">This will give the element a key that can be used to replace the
                                content with a runtime value.</p>
                        </div>
                    )
                    : (<div />)
                }
                ...
                <div className="form-group">
                    ...
                    <div className="custom-control custom-checkbox">
                        <input id="page-break-before-element" className="custom-control-input" type="checkbox"
                               checked={this_checked_page_break} value={true}
                ...
                <div className="form-group">
                    <div className="form-group-range">
                        ...
                        <input id="rangeMin" type="number" className="form-control"
                               defaultValue={this.props.element.min_value} onBlur={this.updateElement.bind(this)}
                ...
                <div className="form-group">
                    <div className="form-group-range">
                        ...
                        <input id="rangeMax" type="number" className="form-control"
                               defaultValue={this.props.element.max_value} onBlur={this.updateElement.bind(this)}
                ...
                <div className="form-group">
                    ...
                    <div className="custom-control custom-checkbox">
                        <input id="do-bold" className="custom-control-input" type="checkbox" checked={this_checked_bold}
                               value={true} onChange={this.editElementProp.bind(this, 'bold', 'checked')} />
                        <label className="custom-control-label" htmlFor="do-bold">
                            Bold
                        </label>
                    </div>
                    <div className="custom-control custom-checkbox">
                        <input id="do-italic" className="custom-control-input" type="checkbox"
                               checked={this_checked_italic} value={true}
                ...
                <div className="form-group">
                    ...
                    <div className="row">
                        <div className="col-sm-6">
                            <input className="form-control" style={{ width: '100%' }} type="text" id="optionsApiUrl"
                ...
                <Accordion defaultActiveKey="1">
                    <CustomRule
                        eventKey="1"
                        onChange={this.editElementProp.bind(this, 'props.customRule', 'value')}
                        element={this.props.element}
                        updateElement={this.props.updateElement}
                    />
                    ...
                    <CustomValidation
                        eventKey="2"
                        onChange={this.editElementProp.bind(this, 'props.customValidation', 'value')}
                        element={this.props.element}
                        updateElement={this.props.updateElement}
                    />
                </Accordion>
