...
export default class FormElementsEdit extends React.Component {
            ...
            <div className="form-group mt-3">
                <div className="custom-control">
                    <label
                        ...
                        htmlFor="span_width"
                    >
                        Span settings. For columns use a number from 1 to 12
                        make sure the sum of the columns is 12. Or enter the
                        widths of each column. Like if you want 3 columns enter
                        3,3,3. You can also append the number with g to use flex
                        grow. For example 1g,100g where the number is a factor
                        of how much width to use.
                    </label>
                    <input
                        id="span_width"
                        type="text"
    ...
    render() {
        ...
        const this_checked = this.props.element.hasOwnProperty("required")
            ...
            : false;
        const this_inline = this.props.element.hasOwnProperty("inline")
        ...
        return (
            <div>
                <div className="clearfix">
                    ...
                    <FapIcon
                        icon="times"
                        className="float-right dismiss-edit"
                ...
                <div className="form-group">
                    ...
                    <input
                        ...
                        className="form-control"
                        defaultValue={
                            this.props.element?.custom_name ||
                            this.props.element.props?.custom_name
                        }
                        onBlur={this.updateElement.bind(this)}
                        onChange={this.editElementProp.bind(
                            this,
                    ...
                    <>
                        <Card className="p-3 my-3">
                            <Textarea
                                ...
                                rows={8}
                            />
                            <Button onClick={this.addStringOptions.bind(this)}>
                                Replace Options
                            </Button>
                        </Card>
                    </>
