...
export default ({timeout = 10} = {}) => {
    ...
    const {getRemainingTimeModal, getLastActiveTimeModal, getRemainingTime} = useIdleTimer({
    ...
    return [{showTimeoutModal, getRemainingTimeModal, getLastActiveTimeModal}, {dismissTimeout, getRemainingTime}];
};
